...
//asus
		...
		nvram_set("modelname", "RTTX1801");
#elif defined(RTAX18T)
		...
		nvram_set("modelname", "RTGAX1800B");
#elif defined(RTGAX1800F)
                nvram_set("modelname", "RTGAX1800F");
#elif defined(RTRX6000)
		nvram_set("modelname", "RTRX6000");
#elif defined(RTMPAX18)
		nvram_set("modelname", "RTMPAX18");
#elif defined(RTKOMIA8)
		nvram_set("modelname", "RTKOMIA8");
#elif defined(RTT6M)
		nvram_set("modelname", "RTT6M");
#elif defined(RTT6GS)
                nvram_set("modelname", "RTT6GS");
#elif defined(RTT6U)
                nvram_set("modelname", "RTT6U");
