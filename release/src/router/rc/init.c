...
//		nvram_set_int("led_2g_gpio", 72|GPIO_ACTIVE_LOW);
	...
	case MODEL_PGBM1:
		...
		nvram_set_int("led_usb_gpio",  5|GPIO_ACTIVE_LOW);
		nvram_set_int("led_5g_gpio", 13|GPIO_ACTIVE_LOW);
		nvram_set_int("led_2g_gpio", 14|GPIO_ACTIVE_LOW);
		nvram_set_int("led_wan_gpio", 17|GPIO_ACTIVE_LOW);
#if defined(RTCONFIG_M2_SSD)
		nvram_set("ehci_ports", "1-2 ata1");
#else
		nvram_set("ehci_ports", "1-2");
#endif
		nvram_set("ohci_ports", "1-2");
	...
	case MODEL_RTAX18T:
		...
		nvram_set_int("led_lan_gpio",  8|GPIO_ACTIVE_LOW);
		nvram_set_int("led_wan_gpio", 7|GPIO_ACTIVE_HIGH);
...
/* [MUST]: Need to Clarify ... */
    ...
    defined(RTCONFIG_RALINK_MT7622)  || defined(RTCONFIG_RALINK_MT7629) || defined(RTCONFIG_RALINK_MT7621)
...
//#if defined(RTCONFIG_WLMODULE_MT7615E_AP)
	system("ln -sf /ra_SKU/l1profile.dat /tmp/etc/wireless/l1profile.dat");
//#else
...
//#endif
	...
	else if ((model == MODEL_RTAX53U) || (model == MODEL_RTAX54) || (model == MODEL_XD4S) || (model == MODEL_PGBM1))
	{
...
#if defined(RTCONFIG_QCA) || defined(RTCONFIG_RALINK_MT7621)
	def_reset_wait = 50;
#endif
