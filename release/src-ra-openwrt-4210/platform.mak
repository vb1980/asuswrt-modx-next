...
define platformKernelConfig
	...
	if [ "$(BUILD_NAME)" = "RT-AX53U" ] || [ "$(BUILD_NAME)" = "RT-AX54" ] || [ "$(BUILD_NAME)" = "4G-AX56" ] || [ "$(BUILD_NAME)" = "H3C-TX1801" ] || [ "$(BUILD_NAME)" = "JCG-Q10PRO" ] || [ "$(BUILD_NAME)" = "PGB-M1" ] || [ "$(BUILD_NAME)" = "XM-CR660X" ] || [ "$(BUILD_NAME)" = "RT-TX1801" ] || [ "$(BUILD_NAME)" = "RT-AX18T" ] || [ "$(BUILD_NAME)" = "RT-HAR" ] || [ "$(BUILD_NAME)" = "RT-GAX1800" ] || [ "$(BUILD_NAME)" = "RT-GAX1800B" ] || [ "$(BUILD_NAME)" = "RT-GAX1800F" ] || [ "$(BUILD_NAME)" = "RT-RX6000" ] || [ "$(BUILD_NAME)" = "RT-MPAX18" ] || [ "$(BUILD_NAME)" = "RT-KOMIA8" ] || [ "$(BUILD_NAME)" = "RT-T6M" ] || [ "$(BUILD_NAME)" = "RT-T6GS" ] || [ "$(BUILD_NAME)" = "RT-T6U" ] || [ "$(BUILD_NAME)" = "RT-CR660X" ] || [ "$(BUILD_NAME)" = "RT-MIR3G" ] || [ "$(BUILD_NAME)" = "RT-CMCCA9" ] || [ "$(BUILD_NAME)" = "RT-Q20" ] || [ "$(BUILD_NAME)" = "RT-XG1" ] ; then \
