...
#if defined(JCGQ10PRO) || defined(H3CTX1801) || defined(PGBM1) || defined(XMCR660X) || defined(RTCMCCA9)|| defined(RTQ20)|| defined(RTTX1801)|| defined(RTAX18T)|| defined(RTHAR)|| defined(RTGAX1800)|| defined(RTGAX1800B)|| defined(RTGAX1800F)|| defined(RTT6M)|| defined(RTT6GS)|| defined(RTT6U)|| defined(RTCR660X)|| defined(RTRX6000)|| defined(RTMPAX18)|| defined(RTKOMIA8)|| defined(JCGQ20)
