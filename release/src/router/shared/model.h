...
#define ASUS_MODELS {   \
	...
	MODELID(MODEL_RTMIR3P),\
	MODELID(MODEL_RTA040WQ),\
	MODELID(MODEL_RTMSG1500),\
	...
	MODELID(MODEL_BC105),\
	MODELID(MODEL_K3),\
	MODELID(MODEL_XWR3100),\
	MODELID(MODEL_R7000P),\
	MODELID(MODEL_EA6700),\
	MODELID(MODEL_SBRAC1900P),\
	MODELID(MODEL_F9K1118),\
	MODELID(MODEL_SBRAC3200P),\
	MODELID(MODEL_R8500),\
	MODELID(MODEL_R8000P),\
	MODELID(MODEL_K3C),\
	MODELID(MODEL_TY6201_RTK),\
	MODELID(MODEL_TY6201_BCM),\
	MODELID(MODEL_RAX120),\
	MODELID(MODEL_DIR868L),\
	MODELID(MODEL_R6300V2),\
	MODELID(MODEL_RMAC2100),\
	MODELID(MODEL_RTMIR3G),\
	MODELID(MODEL_RTTX1801),\
	MODELID(MODEL_RTAX18T),\
	MODELID(MODEL_RTHAR),\
	MODELID(MODEL_RTGAX1800),\
	MODELID(MODEL_RTGAX1800B),\
	MODELID(MODEL_RTGAX1800F),\
	MODELID(MODEL_RTRX6000),\
	MODELID(MODEL_RTMPAX18),\
	MODELID(MODEL_RTKOMIA8),\
	MODELID(MODEL_RTT6M),\
	MODELID(MODEL_RTT6GS),\
	MODELID(MODEL_RTT6U),\
	MODELID(MODEL_RTCR660X),\
	MODELID(MODEL_RTXG1),\
	MODELID(MODEL_R6800),\
	MODELID(MODEL_RAX70),\
	MODELID(MODEL_MR60),\
	MODELID(MODEL_MS60),\
	MODELID(MODEL_PGBM1),\
	MODELID(MODEL_JCGQ10PRO),\
	MODELID(MODEL_RTCMCCA9),\
	MODELID(MODEL_RTQ20),\
	MODELID(MODEL_H3CTX1801),\
	MODELID(MODEL_RMAX6000),\
	MODELID(MODEL_UNR030N),\
	MODELID(MODEL_XMCR660X),\
	MODELID(MODEL_JCGQ20),\
	MODELID(MODEL_MAX)\
}
...
enum {
	...
	SWRT_MODEL_RTAX18T,
	SWRT_MODEL_RTHAR,
	SWRT_MODEL_RTGAX1800,
	SWRT_MODEL_RTGAX1800B,
	SWRT_MODEL_RTGAX1800F,
	SWRT_MODEL_RTRX6000,
	SWRT_MODEL_RTMPAX18,
	SWRT_MODEL_RTKOMIA8,
	SWRT_MODEL_RTT6M,
